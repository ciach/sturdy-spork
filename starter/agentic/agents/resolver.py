...
Do not mention "knowledge base" or "articles" in your response - just provide the information."""
    ...
    def resolve(self, query: str, classification: Dict[str, Any] = None, context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
    ...
    def generate_response_with_context(self, query: str, knowledge_articles: List[Dict], additional_context: str = "") -> str:
        """
        ...
        user_message += f"Knowledge Articles:\n{articles_text}\n\nProvide a helpful response."
