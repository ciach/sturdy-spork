...
Provide a concise escalation summary for the human agent."""
    ...
    def create_interim_response(self, urgency: str, category: str) -> str:
        ...
        if urgency == "critical":
            return base_message + "A senior support specialist will contact you within the next hour to resolve this issue."
        
        elif urgency == "high":
            return base_message + "A specialist will review your case and respond within 4 hours."
        
        else:
            return base_message + "Our support team will review your case and get back to you within 24 hours."
